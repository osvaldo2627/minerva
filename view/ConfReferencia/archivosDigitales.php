<h1 class="title"><a href="#">Selecciones los campos validos para los archivos dititales</a></h1>
<div id="contenidos">
    <form action="?controller=ConfReferencia&action=archivosDigitales" method="POST">
        <table>
            <tr>
                <td>
                    <?php
