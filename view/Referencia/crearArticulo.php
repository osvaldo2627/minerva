<h1 class="title"><a href="#">Crear un Art&iacute;culo</a></h1>
<form action="?controller=Referencia&action=crearArticulo" method="POST">
    <table style="margin-left: 20px;">
        ...
        if ($result['campos']['revista'] == "t") {
            echo "<tr>";
            echo "<td>Revista</td>";
            echo '<td><input type="text" name="revista" value="" /></td>';
            echo "</tr>";
        }
        if ($result['campos']['direccion_contacto_autores'] == "t") {
            echo "<tr>";
            echo "<td>Direcci&oacute;n de contacto de los autores</td>";
            echo '<td><input type="text" name="direccion_contacto_autores" value="" /></td>';
            echo "</tr>";
        }
